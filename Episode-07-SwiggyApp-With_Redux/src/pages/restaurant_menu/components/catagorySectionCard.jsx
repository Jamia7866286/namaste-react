  ...
  return (
    <li className="catagory_section border-b mb-5 pb-5 flex justify-between last-of-type:border-b-0">
      ...
      <div className="min-w-[118px] w-[118px] h-24 rounded-md overflow-hidden relative">
        <img src={ITEM_IMG_CDN_URL + imageId} alt="" className="w-full h-full object-cover" />
        <button className="absolute bottom-0 left-[12] bg-white rounded-md text-green-600 w-[94] h-[34] font-semibold text-xs border border-gray-200 shadow-md">ADD +</button>
      </div>
